...
target_metadata = None  # migrations are explicit SQL; models are not used for autogenerate


def run_migrations_offline() -> None:
    url = get_settings().sqlalchemy_url
    context.configure(url=str(url), literal_binds=True, dialect_opts={"paramstyle": "named"})
